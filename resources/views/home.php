...
<html lang="en">
<head>
    <title>The Cold Turkey Group</title>
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Official website of The Cold Turkey Group">
    <meta name="author" content="The Cold Turkey Group">
...
<header id="header" class="header">
    <div class="container">
        <h1 class="logo">
            <a href="/"><span class="text"><img id="ctg-logo" src="/assets/img/logo-white.png" alt="Cold Turkey Group logo" height="50px" style="height:50px"></span></a>
        </h1>
